...
## 7.2 添加账号
功能要求：  
 * 添加时学生学号不能重复、教师职工编号不能重复  
  
### 7.2.1 添加功能实现
在Manager的**addPerson**成员函数中，实现添加新账号功能  
...
#### 7.2.2.4 bug解决
bug描述：  
 * 虽然可以检测重复的账号，但是刚添加的账号又不与没有更新到容器中，因此不会做检测  
...
## 7.4 查看机房
### 7.4.1 添加机房信息
案例需求中，机房一共有三个，其中1号机房容量为20台机器，2号50台，3号100台  
...
在Manager有参构造函数中，追加初始化机房信息代码  
  
### 7.4.4 显示机房信息
在Manager类的showComputer成员函数中添加代码  
